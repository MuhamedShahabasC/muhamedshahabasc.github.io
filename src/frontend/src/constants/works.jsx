...
export const portfolioData = [
  {
    ...
    category: "Full Stack",
    description: "Comprehensive hostel management platform with three interfaces (student, admin, staff). Features RBAC, room allocation with disability support, issue tracking, real-time chat using Socket.io, and Razorpay payment integration.",
    tech: "MongoDB, Express.js, React, Tailwind CSS, Socket.io",
    projectLinks: {
  ...
  },
  {
    ...
    category: "Full Stack",
    description: "Full-fledged e-commerce application for luxury watches with separate admin and user interfaces. Features complete authentication, order management with delivery tracking, automated invoice generation, and PayPal payment gateway integration.",
  ...
  },
  {
    ...
    tech: "Node.js, MongoDB, React, Tailwind CSS, WebSockets",
    isPlaceholder: true,
    projectLinks: {
      project: null,
      repo: null,
