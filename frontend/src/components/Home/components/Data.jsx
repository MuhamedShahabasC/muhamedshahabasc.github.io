  ...
  return (
    <div className="home__data">
      ...
      <p className="home__description">
        Full-stack developer with 2+ years building enterprise SaaS platforms and microservices in production.
        Currently developing healthcare workflow automation applications at Autonomize AI, with expertise in
        TypeScript, React, Node.js, NestJS, and cloud infrastructure. Experienced in RBAC systems, CI/CD pipelines,
